        ...
        <div class="row">
            ...
            foreach($_SESSION["cart"] as $cart => $hasil) {
               ...
               if($hasil['is_diskon'] == true) {
                  $hargaJual = $hasil['harga_jual'] * $hasil['diskon'] / 100;
                  $harga = $hasil['harga_jual'] - $hargaJual;
               }else{
                  $harga = $hasil['harga_jual'];
               }       

                ?>    
               <div class="col-sm-6 col-md-4 col-lg-12 text-center">
                  <div class="box center">
                  <div class="img-box" style="margin: 50px; padding:10px">
                     <img src="kasir/admin/module/barang/img/<?= $hasil["gambar"]; ?>" width="200" height="200">
                     <div class="detail-box">
                        ...
                        <h6><?php if($hasil['is_diskon'] == true): ?>
                        <strike class="text-muted"><h6 class="text-muted">Rp.<?php echo number_format ($hasil['harga_jual']);?></h6></strike>
                        
                         <div ><h6 style="color:red;"><i>Disc <?=$hasil['diskon'];?>%</i></h6></div><?php endif; ?>
                         Rp.<?php echo number_format($harga); ?>
                        </h6>
                        <a href ="buy/hapus_buy.php?id=<?= $cart?>" class="btn btn-danger">Cancel</a>
                       </div>
                  </div>
               </div>    
            </div>
