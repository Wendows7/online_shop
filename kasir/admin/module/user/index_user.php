						...
						<?php }?>
							<div class="col-sm-3">
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										<center><img src="admin/module/add_user/img/<?php echo $hasil['gambar'];?>"  alt="#" style="width:200px;border:4px solid #ddd;"/></center>			
									</div>
									<div class="panel-footer">
										<form method="POST" action="fungsi/edit/edit_user.php?gambar=user" enctype="multipart/form-data">
								...
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										<div class="box-content">
											<form class="form-horizontal" method="POST" action="fungsi/edit/edit_user.php?profil=edit" enctype="multipart/form-data">
												<fieldset>
							...
							<div class="col-sm-4">
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										<div class="box-content">
											 <form class="form-horizontal" method="POST" action="fungsi/edit/edit_user.php?pass=ganti-pas">
