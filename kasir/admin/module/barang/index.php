						...
						<div class="modal-view">
							<table class="table table-bordered table-striped" id="example1">
								...
								?>
									<tr>
										<td><?php echo $no;
										 $penyimpanan = "admin/module/barang/temp/";
										 if (!file_exists($penyimpanan))
									  mkdir($penyimpanan);
										$kode = "keranjang/tambah.php?id=".$isi["id"]."";
										require_once('assets/phpqrcode/qrlib.php');
										QRcode::png("$kode",$penyimpanan."/kode".$isi["id"].".png","H", 5,5);     ?></td>
										...
										<td><center>
                     					 <img src="admin/module/barang/temp/kode<?= $isi["id"]?>.png" width="50" alt=""><br><a href= "admin/module/barang/print.php?id=<?=$isi['id']; ?>" target="_blank"><button class="btn btn-info btn-xs">Print</button></a><br><a href= "admin/module/barang/print_all.php?id=<?=$isi['id']; ?>" target="_blank"><button class="btn btn-success btn-xs"> Print All</button></a></center>
                    					</td>
										<td>
											<?php if($isi['stok'] <=  '3'){?>
											...
											<a href="fungsi/hapus/hapus.php?barang=hapus&id=<?php echo $isi['id_barang'];?>&gambar=<?= $isi['gambar'];?>" onclick="javascript:return confirm('Hapus Data barang ?');"><button class="btn btn-danger btn-xs">Hapus</button></a>
											<?php }?>
								...
								<form action="fungsi/tambah/tambah.php?barang=tambah" method="POST" enctype="multipart/form-data">
									<div class="modal-body">
										...
										<table class="table table-striped bordered table-responsive">
											...
											<tr>
												<td>Gambar Barang Utama</td>
												<td><input type="file" name="gambar"></td>
											</tr>
											<tr>
												<td>Gambar Barang 2</td>
												<td><input type="file" name="gambar2"></td>
											</tr>
											<tr>
												<td>Gambar Barang 3</td>
												<td><input type="file" name="gambar3"></td>
											</tr>
									
											<tr>
												<td>Deskripsi Barang</td>
												<td><textarea type="text" placeholder="Deskripsi Barang" required class="form-control"  name="deskripsi" rows="5" cols="65"></textarea></td>
											</tr>
											<tr>
												<td>Merk Barang</td>
											...
											<tr>
												<td>Is Discount</td>
												<td><select name="is_diskon" class="form-control" required>
											...
											<tr>
												<td>Diskon</td>
												<td><input type="number" value="0" required class="form-control"  name="diskon"></td>
											</tr>
											<tr>
												<td>Satuan Barang</td>
												<td>
