							...
							<div class="panel panel-primary">
								<div class="panel-heading">
									...
									<a class="btn btn-danger pull-right" 
										...
										style="margin-top:-0.5pc;" href="fungsi/hapus/hapus_user.php?penjualan=jual">
								...
								<div class="panel-body">
									<div id="keranjang">
										...
										<table class="table table-bordered" id="example1">
											...
											<tbody>
												...
												<form method="POST" action="fungsi/edit/edit_user.php?jual=jual">
												...
												<!-- aksi ke table penjualan -->
														<a href="fungsi/hapus/hapus_user.php?jual=jual&id=<?php echo $isi['id_penjualan'];?>&brg=<?php echo $isi['id_barang'];?>
									...
									<div id="kasirnya">
										<table class="table table-stripped">
											...
											?>
											<!-- aksi ke table nota -->
											<form method="POST" action="index_user.php?page=jual&nota=yes#kasirnya">
												<?php foreach($hasil_penjualan as $isi){;?>
												...
												<tr>
													...
													<?php  if(!empty($_GET['nota'] == 'yes')) {?>
													 <a class="btn btn-danger" href="fungsi/hapus/hapus_user.php?penjualan=jual">
...
$(document).ready(function(){
	$("#cari").change(function(){
		$.ajax({
		type: "POST",
		url: "fungsi/edit/edit_user.php?cari_barang=yes",
