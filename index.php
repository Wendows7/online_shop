...
<body>
                        ...
                        <div class="col-md-7 col-lg-6 ">
                           <div class="detail-box">
                              <h1>
                                 ...
                                 <br>
                                 On Everything Product
                              </h1>
                              <p style="color:white;">
                                 Semua Product yang ada di toko ini bisa anda dapatkan diskon sebesar 20%
                              </p>
                              <div class="btn-box">
                        ...
                        <div class="col-md-7 col-lg-6 ">
                           <div class="detail-box">
                              <h1>
                                 ...
                                 <br>
                                 If You Visit The Shop
                              </h1>
                              <p>
                                 Jika Anda Langsung Datang Ke Toko Anda Bisa Mendapatkan Diskon Sebesar 50% Di beberapa Produk Tertentu
                              </p>
                              <div class="btn-box">
                                 <a href="product.php" class="btn1">
                                    Shop Now
   ...
   <section class="arrival_section">
      <div class="container">
         <div class="box">
            <div class="row">
               <div class="arrival_bg_box" style="display:inline-block;z-index: 0;">
                  <img src="images/butik5.jpg" alt="">
               </div>
            </div>
            <div class="row">
               <div class="col-md-6 ml-auto">
                  ...
                  <p style="margin-top: 20px;margin-bottom: 30px;">
                     Ini Adalah Produk Produk Terbaru Kami, Dan Menjadi Rekomendasi Terbaik Dari Kami
                  </p>
                  <a href="product.php">
                     Shop Now
                  </a>
